  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-100">
      ...
      <div className="relative z-10 flex flex-col items-center px-4 pt-8 pb-20 lg:pt-12 lg:pb-24 max-w-5xl mx-auto">
        ...
        <div
          className="relative rounded-2xl border-2 p-3 lg:p-4 w-full max-w-sm text-center cursor-pointer transition-all hover:border-opacity-60 flex flex-col items-center bg-white shadow-sm"
          style={{
            borderColor: "rgba(197, 160, 89, 0.3)",
          }}
        ...
        >
          ...
          {editingCompany ? (
            ...
            <div>
              ...
              <p className="text-lg lg:text-xl font-bold mt-0.5" style={{ color: NAVY }}>
