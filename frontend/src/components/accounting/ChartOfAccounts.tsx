...
export const DEFAULT_PANAMA_CHART: Account[] = [
  ...
  { id: "38", account_code: "4.1", account_name: "Ingresos por Ventas", account_type: "ingreso", parent_code: "4.0", level: 2, is_header: true, normal_balance: "haber", is_active: true },
  { id: "38a", account_code: "4.1.1", account_name: "Ventas de Mercancia", account_type: "ingreso", parent_code: "4.1", level: 3, is_header: false, normal_balance: "haber", is_active: true },
  { id: "39", account_code: "4.2", account_name: "Ingresos por Servicios", account_type: "ingreso", parent_code: "4.0", level: 2, is_header: true, normal_balance: "haber", is_active: true },
  { id: "39a", account_code: "4.2.1", account_name: "Servicios Prestados", account_type: "ingreso", parent_code: "4.2", level: 3, is_header: false, normal_balance: "haber", is_active: true },
  { id: "40", account_code: "4.3", account_name: "Otros Ingresos", account_type: "ingreso", parent_code: "4.0", level: 2, is_header: true, normal_balance: "haber", is_active: true },
  { id: "40a", account_code: "4.3.1", account_name: "Otros Ingresos Varios", account_type: "ingreso", parent_code: "4.3", level: 3, is_header: false, normal_balance: "haber", is_active: true },
  { id: "41", account_code: "4.4", account_name: "Descuentos sobre Ventas", account_type: "ingreso", parent_code: "4.0", level: 2, is_header: true, normal_balance: "debe", is_active: true },
  { id: "41a", account_code: "4.4.1", account_name: "Descuentos sobre Ventas", account_type: "ingreso", parent_code: "4.4", level: 3, is_header: false, normal_balance: "debe", is_active: true },
  { id: "42", account_code: "4.5", account_name: "Devoluciones sobre Ventas", account_type: "ingreso", parent_code: "4.0", level: 2, is_header: true, normal_balance: "debe", is_active: true },
  { id: "42a", account_code: "4.5.1", account_name: "Devoluciones sobre Ventas", account_type: "ingreso", parent_code: "4.5", level: 3, is_header: false, normal_balance: "debe", is_active: true },
  // COSTOS Y GASTOS
  ...
  { id: "45", account_code: "5.1.1", account_name: "Compras de Mercancia", account_type: "costo_gasto", parent_code: "5.1", level: 3, is_header: false, normal_balance: "debe", is_active: true },
  { id: "46", account_code: "5.1.2", account_name: "Fletes de Importacion", account_type: "costo_gasto", parent_code: "5.1", level: 3, is_header: false, normal_balance: "debe", is_active: true },
